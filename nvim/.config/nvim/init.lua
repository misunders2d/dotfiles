...
vim.opt.foldcolumn = "1" -- Set to "1" if you want a little column on the left showing folds
...
-- Keybindings to move lines up or down
...
require("lazy").setup({
...

	{
		...
		keys = {
			{ "<leader>cc", "<cmd>CodeCompanionActions<cr>", mode = { "n", "v" }, desc = "Code Companion Actions" },
